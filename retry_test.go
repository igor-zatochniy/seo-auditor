...
func TestRetryRoundTripperRetriesTransientHTTPStatus(t *testing.T) {
	...
	transport := &retryRoundTripper{
		...
		policy: retryPolicy{maxRetries: 2, baseDelay: time.Nanosecond, maxDelay: time.Microsecond},
	}
...
func TestRetryRoundTripperRetriesConnectionReset(t *testing.T) {
	...
	transport := &retryRoundTripper{
		...
		policy: retryPolicy{maxRetries: 1, baseDelay: time.Nanosecond, maxDelay: time.Microsecond},
	}
